...
function HouseIllustration({ small = false }: { small?: boolean }) {
  const w = small ? 200 : 280;
  const h = small ? 114 : 160;
  return (
    <div className="dash-login__hero-illustration" aria-hidden>
      <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" className="dash-login__hero-svg" width={w} height={h}>
        <defs>
        ...
        <rect width="280" height="160" fill="url(#skyGrad2)" />
        ...
        <rect x="0" y="112" width="280" height="48" fill="url(#grassGrad2)" rx="6"/>
        <rect x="90" y="70" width="100" height="50" fill="url(#houseGrad2)" rx="4"/>
